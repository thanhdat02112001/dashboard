                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-flex align-items-center">
                                <input class="form-control text-center date-input filter-data"
                                       ...
                                       name="daterange"
                                />
                                {{ Form::select('select-date', ['Hôm qua','7 ngày gần nhất', '30 ngày gần nhất', 'Tháng này', 'Tháng trước'] , null, ['id' => 'select-date', 'class' => 'form-control text-center date-input filter-data filter-date', 'placeholder' => 'Hôm nay']) }}
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
